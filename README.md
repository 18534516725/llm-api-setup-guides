...
> 当前共 **121 篇中文文档，覆盖 83 款工具、协议、平台与开发框架**。不知道选哪个？先打开支持站内搜索的 **[在线中文文档站](https://docs.nexotoken.net/)**，或查看 **[GitHub 教程总目录](./guides/教程总目录.md)** 和 **[兼容性总表](./guides/basics/compatibility-matrix.md)**。
...
| **[MCP Apps](./guides/developer-integration/mcp-apps.md)** | 交互式 MCP UI、资源、iframe 与 CSP | ⭐⭐⭐ | ✅ 已发布 |
| **[Microsoft Agent Framework](./guides/developer-integration/microsoft-agent-framework.md)** | Python Agent、Workflow、Harness 与 A2A | ⭐⭐⭐ | ✅ 已发布 |
| **[Mastra](./guides/developer-integration/mastra.md)** | TypeScript Agent、Tools、Memory 与 Workflow | ⭐⭐⭐ | ✅ 已发布 |
| **[Browser Use](./guides/developer-integration/browser-use.md)** | 浏览器自动化 Agent、CLI、MCP 与权限 | ⭐⭐⭐ | ✅ 已发布 |
| **[Daytona](./guides/developer-integration/daytona.md)** | AI 代码 Sandbox、Snapshot、网络限制与回收 | ⭐⭐⭐ | ✅ 已发布 |
...
| **[MCP 2026-07-28](./guides/basics/mcp-2026-07-28.md)** | 无状态核心、Discovery、MRTR、Extensions 与迁移 |
| **[Agent Skills](./guides/basics/agent-skills.md)** | SKILL.md、渐进加载、触发评测与脚本安全 |
| **[ACP](./guides/basics/agent-client-protocol.md)** | 编辑器与编程 Agent 的会话、流式事件和权限 |
| **[A2A](./guides/basics/a2a-protocol.md)** | Agent Card、Task、Artifact 与跨 Agent 协作 |

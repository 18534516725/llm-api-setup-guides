...
### 第十四阶段：高意图 API 配置与验证教程

- 新增 20 篇围绕 Base URL、协议、错误、成本、Agent、SDK 和契约测试的高意图教程；
- 修正文档数量口径，当前共 120 篇中文文档；
- 从公开文档构建中排除 404 页面和贡献者模板，避免进入 sitemap；
- 更新 Codex、Claude Code、Cursor、Cherry Studio 和 API 基础页的核验日期。

## 2026-08-12

### 第十二阶段：搜索意图与 API 中转选择指南

- 新增“API 中转站是什么、怎么用、怎么选”支柱指南，覆盖协议、Base URL、API Key、模型 ID、计费、安全、稳定性、最小请求和退出方案；
- 按当前搜索需求重新组织 Codex、Claude Code、Cursor、Cherry Studio、OpenAI-compatible API 与 401 / 404 / 429 排错入口；
- 统一 README、文档站、导航和仓库元信息，避免重复页面和机械关键词堆砌；
- 当前共 88 篇中文文档，继续覆盖 74 款工具、平台与开发框架。
